...
clusterMCL(graph345, nodes345, adj345)

clusterK = function(graphK, nodesK, adjK){
  #K-Means#
...
################################
# FAST GREEDY #
kc = fastgreedy.community(graph239)
kc2 = cut_at(kc, 4)
...
SCVec0 = specClust(adjMat = adj0, nBlocks = 20, nIter = 1000)
